...
INSERT INTO `subcategorys` (`id`, `name`) VALUES
...
(14, 'ปริญญา', 'แซ่อั้ง', 'i@gmail.com', '$2y$10$RiRxpZmtI6lQyzzfB9cjZe/r3gTi.sWopObP3ROTWyZmR964Vo.aa', 1);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`s_id`) REFERENCES `subcategorys` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
